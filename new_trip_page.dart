...
class _NewTripPageState extends State<NewTripPage>
{
  ...
  String buttonTitleText = "LLEGASTE A RECOGER?";
  ...
  obtainDirectionAndDrawRoute(sourceLocationLatLng, destinationLocationLatLng) async
  {
    showDialog(
        ...
        context: context,
        builder: (BuildContext context) => LoadingDialog(messageText: 'Espera...',)
    );
  ...
  getLiveLocationUpdatesOfDriver()
  {
    ...
    positionStreamNewTripPage = Geolocator.getPositionStream().listen((Position positionDriver)
    {
      ...
      Marker carMarker = Marker(
        ...
        icon: carMarkerIcon!,
        infoWindow: const InfoWindow(title: "Mi Localización"),
      );
  ...
  endTripNow() async
  {
    ...
    // Llamada a la función para restar el monto del recargo
    subtractAmountFromRecarga(fareAmount);
  }
                    ...
                    Center(
                      child: ElevatedButton(
                        onPressed: () async
                        {
                          ...
                          {
                            setState(() {
                              buttonTitleText = "FINALIZAR EL VIAJE";
